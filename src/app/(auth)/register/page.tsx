  ...
  return (
    <div className="w-full space-y-8 animate-in fade-in zoom-in duration-500">
      <div className="text-center">
        <h2 className="text-3xl font-extrabold text-white tracking-tight drop-shadow-md">Crie sua conta</h2>
        <p className="mt-2 text-sm text-gray-300">
          Já tem uma conta? <Link href="/login" className="font-medium text-blue-400 hover:text-blue-300 transition-colors">Faça login</Link>
        </p>
      </div>
